...
// HERO SLIDES ROUTES
// ============================================
router.post('/hero-slides', uploadSingle, handleMulterError, adminController.createHeroSlide);
router.get('/hero-slides', adminController.getAllHeroSlides);
router.get('/hero-slides/:id', adminController.getHeroSlideById);
router.put('/hero-slides/:id', uploadSingle, handleMulterError, adminController.updateHeroSlide);
...
// ============================================
router.post('/persons', uploadSingle, handleMulterError, adminController.createPerson);
...
router.put('/persons/:id', uploadSingle, handleMulterError, adminController.updatePerson);
